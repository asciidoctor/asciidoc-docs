...
Being an uncontrained pair, the double plus passthrough can be used anywhere in the text.
...
If you want to do both, you must enclose the pair in a monospace formatting pair, known as xref:text:monospace.adoc#literal-monospace[literal monospace].
