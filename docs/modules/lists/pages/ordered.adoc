...
Instead, use a list continuation—a `{plus}` symbol on its own line—between the numbered list items and all other content elements in your list.

* For how-to details, see the https://docs.asciidoctor.org/asciidoc/latest/lists/continuation/[List Continuation^] section of this documentation. 
