...
Instead, use a list continuation—a `{plus}` symbol on its own line—between the numbered list items and all other content elements in your list, as shown here:
