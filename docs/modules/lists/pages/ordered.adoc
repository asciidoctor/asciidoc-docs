...
You may see this behavior after figures or after multiparagraph steps. 
...
Instead, use the list continuation symbol (`{plus}`) between the numbered list items and all other content elements in your list.
