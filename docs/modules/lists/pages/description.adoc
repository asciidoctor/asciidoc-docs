...
This list type is useful when you need to provide a description, definition, or supporting text for a list of terms.

NOTE: You may know this list variation by its former term, _definition list_.
...
* one or more terms, each followed by a separator (typically a double colon, `::`)
