...
A description list (often abbreviated as dlist in AsciiDoc) is an association list that consists of one or more pairs of terms that have attached text and/or blocks.
This list type is useful when you need to associate terms with a description, definition, or supporting text.
...
When the term delimiter is changed, that term starts a new, nested description list (similar to how ordered and unordered lists work).
...
Notice how the term delimiter is varied to create a nested description list.
