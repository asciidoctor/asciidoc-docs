...
While the level of nesting is not determined by the number of characters in the delimiter, it's customary to use the delimiters in this order to provide a hint that the list is nested at a given level.
