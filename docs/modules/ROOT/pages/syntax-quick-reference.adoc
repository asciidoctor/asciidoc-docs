...
You can force two adjacent lists apart by adding a blank attribute list (i.e., `[]`) above the second list or by inserting an empty line followed by a line comment after the first list.
