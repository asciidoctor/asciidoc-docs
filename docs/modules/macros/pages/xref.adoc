...
If the cross reference only specifies the ID, the formatted title of the target element is automatically used as the link text.
If the element does not have a title, a stylized form of the ID is used instead.
