...
For the chapter and appendix number, you currently have to register the value using the counter directive to the number prior to the number you want to start with (e.g., `+:appendix-number: {counter:appendix-number:@}+`).
// end::table[]
