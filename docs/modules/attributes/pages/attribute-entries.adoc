...
That also means that the xref:subs.adoc[special characters and quote substitutions] are not applied to the value of that attribute when it is referenced in the document.
