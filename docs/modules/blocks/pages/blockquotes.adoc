...
[WARNING]
====
Not all AsciiDoc syntax elements
work within Markdown-style blockquotes,
and some may even prevent the "blockquote" from being recognized as such.
For complex quote content,
prefer the quoted block syntax described <<quote-block-syntax,above>>.

Even elements documented <<ex-md-block,below>>,
such as lists within Markdown-style blockquotes,
may stop working in future versions of the language.
====
