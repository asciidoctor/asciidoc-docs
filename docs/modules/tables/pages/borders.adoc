...
The frame attribute defaults to the value `all`, which draws a border on each side of the table.
...
The grid attribute defaults to the value `all`, which draws a border between all cells.
