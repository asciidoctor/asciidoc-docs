...
.Explicit section ID (aka anchor)
----
[#null-values]
...
When indent is greater than 0, the leading block indent is first stripped (tabs are replaced with 4 spaces), then a block is indented by the number of columns equal to this value.
====
